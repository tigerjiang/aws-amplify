...
var PubSubClass = /** @class */ (function () {
    ...
    //位置 node_moudles/@aws-amplify/pubsub/lib-esm/PubSub.js/127行
    PubSubClass.prototype.clearPluggables = function () {
        this._pluggables = [];
    };
    PubSubClass.prototype.restartAWSIoTProvider = function (pluggable) {
        this._pluggables[0] = pluggable;
    };
